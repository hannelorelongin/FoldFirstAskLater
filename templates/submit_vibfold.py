...
FASTA_FILE = 'inputfasta'        # location of fasta file between '' - absolute or relative path possible
IS_COMPLEX = False                       # True or False
MSA_MODE = 'mmseqs2_server'             # 'alphafold_default' or 'mmseqs2_server'
SAVE_DIR = 'results'               # location of results directory between '' - abs or rel path possible
